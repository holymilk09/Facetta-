...
EXPECTED_PRODUCTION_OPERATIONS = (
    ...
    | _operations(
        ...
        "/studio/projects/{project_root_id}/continuation-prompts",
        "/studio/projects/{project_root_id}/preview-candidates",
        "/studio/preview-candidates/{candidate_id}",
        "/studio/preview-candidates/{candidate_id}/image",
    ...
    | _operations(
        ...
        "/studio/preview-candidates/{candidate_id}/decision",
...
def test_production_hides_legacy_admin_and_stateless_spec_adapters(monkeypatch):
    ...
    with TestClient(production_app) as client:
        ...
        for method, path in (
            ...
            ("get", "/studio/projects/known/continuation-prompts"),
            ("get", "/studio/projects/known/preview-candidates"),
            ("get", "/studio/preview-candidates/known"),
            ("get", "/studio/preview-candidates/known/image"),
            ("post", "/studio/preview-candidates/known/decision"),
