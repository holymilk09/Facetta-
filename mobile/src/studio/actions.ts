...
export const STUDIO_ACTIONS: readonly StudioActionDefinition[] = [
  {
    ...
    fields: [
      ...
      { id: 'construction', label: 'Construction detail', kind: 'reference', required: false, referenceRole: 'construction_detail' },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'direction', label: 'Optional art direction', kind: 'text', required: false },
    ],
